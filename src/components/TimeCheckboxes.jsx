...
const TimeCheckboxes=(props)=>{


    const [checked,setChecked]=useState(false);
    const timeOptions = ['8:00 AM', '8:30 AM', '9:00 AM', '9:30 AM', '10:00 AM', '10:30 AM', '11:00 AM',
        ...
        <>
            <div className="time-options">
                {timeOptions.map((time) => (
                    <div key={time} className="checkbox-container">
                        <input value={checked} type="checkbox" id={time} name={time} onChange={handleOnChange} />
